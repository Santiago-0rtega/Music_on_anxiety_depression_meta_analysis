# Batch 01 Part 01 Prompt: Camargo2013 and Chen2019

Use this prompt after uploading the five Batch 01 study PDFs, `study_manifest.md`,
and all shared rule files. This two-study prompt is preferred over the five-study
wide prompt because NotebookLM Studio may truncate or omit rows in very wide
tables.

```text
Create a Google Sheet or Studio Data Table named "CRIME-Q music extraction batch 01 part 01".
...
The table must have exactly 2 rows, one row per study, in this order:
Camargo2013
Chen2019
...
For every item, apply CRIME-Q_CODEBOOK_FOR_NOTEBOOKLM.md.

Use exactly the columns in WIDE_SHEET_COLUMN_TEMPLATE.md.
