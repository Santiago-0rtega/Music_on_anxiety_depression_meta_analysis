# Batch 02 Short NotebookLM Prompt

Use after uploading the five study PDFs in `study_manifest.md` plus all files in
`../shared_rules/`.

```text
Using only the uploaded sources, create a Google-Sheets-ready wide table for "CRIME-Q music extraction batch 02".
...
Flores2018, Freitas2020, Fu2023, Fu2025, Krishnamurthy2025.
