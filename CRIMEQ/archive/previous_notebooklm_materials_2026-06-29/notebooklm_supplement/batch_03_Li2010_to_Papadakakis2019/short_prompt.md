# Batch 03 Short NotebookLM Prompt

Use after uploading the five study PDFs in `study_manifest.md` plus all files in
`../shared_rules/`.

```text
Using only the uploaded sources, create a Google-Sheets-ready wide table for "CRIME-Q music extraction batch 03".
...
Li2010, Milbratz2017, Niehues2011, Pangemanan2024, Papadakakis2019.
