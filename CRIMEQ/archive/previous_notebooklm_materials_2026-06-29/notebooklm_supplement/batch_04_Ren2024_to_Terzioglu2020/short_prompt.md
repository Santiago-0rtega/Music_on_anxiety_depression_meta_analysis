# Batch 04 Short NotebookLM Prompt

Use after uploading the five study PDFs in `study_manifest.md` plus all files in
`../shared_rules/`.

```text
Using only the uploaded sources, create a Google-Sheets-ready wide table for "CRIME-Q music extraction batch 04".
...
Ren2024, Rizzolo2021, Saghari2021, Sampaio2017, Terzioglu2020.
