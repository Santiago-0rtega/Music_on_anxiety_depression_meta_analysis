...
mLE <- rma.mv(yi = lnVR, # Changed to lnVR
                  V = VCV_filtered, 
              mods = ~ Outcome_type+Lifestage_exposure,
                  random = list(~1 | Study_ID,
                                ~1 | ES_ID,
                                ~1 | Strain),
                  test = "t",
...
```{r}
summary(glht(mLE, linfct=cbind(contrMat(rep(1,7), type="Tukey"))), test=adjusted("none"))
```
...
#cond_means<-orchaRd::mod_results(mLE,group="Study_ID",mod="Lifestage_exposure",by="Outcome_type", weights="prop")
...
db_filtered2 <- db_filtered %>%
  filter(Sex %in% levels_to_keep)


indices_to_keep <- which(db_filtered2$Sex %in% levels_to_keep)
VCV_filtered2 <- VCV_filtered[indices_to_keep, indices_to_keep]
```
...
#cond_means<-orchaRd::mod_results(mSX,group="Study_ID",mod="Sex",by="Outcome_type", weights="prop")
...
```
```{r}
summary(glht(mMG, linfct=cbind(contrMat(rep(1,5), type="Tukey"))), test=adjusted("none"))
```
Meta_genre	0.1273	0.3021	0.4215	214	0.6738	-0.4681	0.7227	
Meta_genrePopular Contemporary Music	1.2294	0.3296	3.7301	214	0.0002	0.5798	1.8791	***
Meta_genre	1.2961	0.4610	2.8114	214	0.0054	0.3874	2.2049	**
Meta_genreWestern Art Music / Orchestral
```{r}
...
#cond_means<-orchaRd::mod_results(mMG,group="Study_ID",mod="Meta_genre",by="Outcome_type", weights="prop")
...
indices_to_keep <- which(db_filtered2$Music_exposure_duration %in% levels_to_keep)
VCV_filtered2 <- VCV_filtered[indices_to_keep, indices_to_keep]
```
...
mMED <- rma.mv(yi = lnVR,
                  V = VCV_filtered2, 
              mods = ~ Music_exposure_duration + Outcome_type,
                  random = list(~1 | Study_ID,
                                ~1 | ES_ID, 
                                ~1 | Strain),
                  test = "t",
...
```
```{r}
summary(glht(mMED, linfct=cbind(contrMat(rep(1,4), type="Tukey"))), test=adjusted("none"))
```
...
#cond_means<-orchaRd::mod_results(mMED,group="Study_ID",mod="Music_exposure_duration",by="Outcome_type", weights="prop")
...
mEXD <- rma.mv(yi = lnVR,
                  V = VCV_filtered, 
              mods = ~ Experimental_design + Outcome_type,
                  random = list(~1 | Study_ID,
                                ~1 | ES_ID, 
                                ~1 | Strain),
                  test = "t",
...
```{r}
summary(glht(mEXD, linfct=cbind(contrMat(rep(1,4), type="Tukey"))), test=adjusted("none"))
```
...
# cond_means<-orchaRd::mod_results(mEXD,group="Study_ID",mod="Experimental_design",by="Outcome_type", weights="prop")
...
mIB <- rma.mv(yi = lnVR,
                  V = VCV_filtered, 
              mods = ~ `Induced behaviour` + Outcome_type,
                  random = list(~1 | Study_ID,
                                ~1 | ES_ID, 
                                ~1 | Strain),
                  test = "t",
...
mRT <- rma.mv(yi = lnVR,
                  V = VCV_filtered, 
              mods = ~ Relative_timing + Outcome_type,
                  random = list(~1 | Study_ID,
                                ~1 | ES_ID, 
                                ~1 | Strain),
                  test = "t",
...
```
```{r}
summary(glht(mRT, linfct=cbind(contrMat(rep(1,4), type="Tukey"))), test=adjusted("none"))
```
```{r}
...
mEXP <- rma.mv(yi = lnVR,
                  V = VCV_filtered, 
              mods = ~ Experimental_procedures + Outcome_type,
                  random = list(~1 | Study_ID,
                                ~1 | ES_ID, 
                                ~1 | Strain),
                  test = "t",
...
```
```{r}
summary(glht(mEXP, linfct=cbind(contrMat(rep(1,3), type="Tukey"))), test=adjusted("none"))
```
```{r}
...
mCC <- rma.mv(yi = lnVR,
                  V = VCV_filtered, 
              mods = ~ Control_conditions + Outcome_type,
                  random = list(~1 | Study_ID,
                                ~1 | ES_ID, 
                                ~1 | Strain),
                  test = "t",
...
```
```{r}
summary(glht(mCC, linfct=cbind(contrMat(rep(1,3), type="Tukey"))), test=adjusted("none"))
```
